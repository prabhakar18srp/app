...
import { Sparkles, Settings, LayoutDashboard, User, LogOut, Shield } from 'lucide-react';
...
const Navigation = () => {
  const { user, handleLogout, setShowAuthModal, checkAuth } = useContext(AuthContext);
